...
submissions = client.get_all_notes(invitation='ICLR.cc/2025/Conference/-/Submission', details='directReplies')
...
for r in reviews:
    if r['forum'] not in scores_dict:
        scores_dict[r['forum']] = []
    scores_dict[r['forum']].append(int(r['content']['rating']['value']))
